...
def ingest(uri_path:str, sep:str, type_trait:str, mapping_file:str, file_path:str, create_tiledb:bool, type_sumstat:str, pvar_file:str = None, qc:bool = False, only_meta:bool = False):
