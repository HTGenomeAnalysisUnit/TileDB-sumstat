...
#### To check how to use the standalone tdbsumstat program instead check here [HERE](https://github.com/HTGenomeAnalysisUnit/TileDB-sumstat/blob/nextflow_branch/docs/README)
