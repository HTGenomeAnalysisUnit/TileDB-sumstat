...
RUN mkdir -p $MAMBA_ROOT_PREFIX /usr/local/bin \
...
# We create the env under $MAMBA_ROOT_PREFIX/envs/tdbsumstat

# Put the env's bin first in PATH for runtime
ENV PATH=$MAMBA_ROOT_PREFIX/envs/tdbsumstat/bin:$PATH
